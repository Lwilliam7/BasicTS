...
- Sequential COSTARTS MAE `0.347935` +/- `0.000000`.
- Zero-threshold sequential MAE `0.348716` +/- `0.000000`.
- Average queried experts `3.560` +/- `0.000`.
- Improvement over best fixed pair `0.003831` +/- `0.000000`.
- Utility correlation `0.0511`; useful-query AUC `0.5058`.
