...
- Train-selected current-best architecture validation MAE: `0.363112`.
- Difference vs previous `0.363112`: `0.000000`.
...
| Train-selected current-best model | `0.363112` | `0.306057` | `both_variable_decay0.95_cap0.1_marginbp200_warm96` |
