"""Train a COSTARTS-style frozen-expert router from offline expert caches."""
...
class COSTARTSTrainingConfig:
    ...
    output_dir: str = "checkpoints/costarts"
    results_dir: str = "results/router_summary/costarts"
    batch_size: int = 512
...
class COSTARTSRouter(nn.Module):
    """Cost-aware sequential expert selector for frozen forecasting experts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train COSTARTSRouter on router_train and select on router_val.")
    parser.add_argument("--data-dir", default="datasets/ETTh1")
    parser.add_argument("--checkpoint-dir", default="checkpoints")
    parser.add_argument("--output-dir", default="checkpoints/costarts")
    parser.add_argument("--results-dir", default="results/router_summary/costarts")
