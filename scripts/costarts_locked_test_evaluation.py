...
try:
    from scripts import train_costarts_pair_selector as pair_selector
    from scripts.evaluate_costarts_pair_selector_gate import confidence_scores_from_logits
except ImportError:
    import train_costarts_pair_selector as pair_selector
    from evaluate_costarts_pair_selector_gate import confidence_scores_from_logits
